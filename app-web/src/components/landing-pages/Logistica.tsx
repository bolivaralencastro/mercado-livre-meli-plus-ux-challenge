...
const testimonials: Testimonial[] = [
  {
    ...
    initials: "AS",
    role: "Cliente Meli+",
    text: '"Comprei um presente de última hora e chegou no dia seguinte. O frete grátis salvou meu natal."',
  ...
  },
  {
    ...
    text: '"Faço muitas compras pequenas de mercado. Antes pagava frete em tudo, agora é tudo grátis."',
  ...
  },
  {
    ...
    text: '"A devolução agilizada é incrível. O correio busca na minha casa, sem custo nenhum."',
...
const faqItems: FaqItem[] = [
  {
    question: "O frete é grátis para qualquer valor?",
    answer: "Com o Meli+, você tem frete grátis em milhões de produtos selecionados a partir de R$ 29, e descontos significativos no frete de produtos abaixo desse valor.",
  },
  {
    question: "O que é entrega Full?",
    answer: "São produtos armazenados diretamente nos centros de distribuição do Mercado Livre. Isso garante o envio mais rápido do Brasil, muitas vezes chegando no dia seguinte ou até no mesmo dia.",
  },
  {
    question: "Posso agendar a entrega?",
    answer: "Em algumas regiões e para produtos selecionados, o Meli+ oferece opções de entrega agendada ou 'Seu Dia de Entregas' para receber tudo de uma vez.",
  },
  {
    question: "Como funciona a devolução?",
    answer: "Se você não gostar do produto, a devolução é grátis e facilitada. Dependendo do seu nível Meli+, o processo é ainda mais ágil e o reembolso é instantâneo.",
  },
];
  ...
  return (
    <RevealOnScroll delay={delay}>
      <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-transparent transition-all duration-300 h-full">
        <div className="text-[#00a650] text-3xl mb-4 transition-transform duration-300 group-hover:scale-110">
          <Icon size={32} />
        </div>
    ...
    <div className={styles.container}>
      ...
      <section className="py-16 text-center relative overflow-visible bg-white">
        <div className="max-w-[1200px] mx-auto px-5 relative">
          <RevealOnScroll>
            <h2 className="text-4xl font-semibold text-gray-900 mb-3">Entrega mais rápida do Brasil</h2>
            <p className="text-gray-600 mb-12">Benefícios logísticos exclusivos para assinantes</p>
          </RevealOnScroll>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <BenefitCard
              ...
              description="Milhões de produtos com frete grátis a partir de R$ 29. Sem pegadinhas."
              delay={0.1}
            />
            <BenefitCard
              icon={Clock}
              title="Chega Amanhã"
              description="Compre hoje e receba amanhã. A entrega mais rápida do mercado."
              delay={0.2}
            />
            <BenefitCard
              icon={Box}
              title="Devolução Facilitada"
              description="Não gostou? Devolva de graça e receba seu dinheiro de volta na hora."
              delay={0.1}
            />
          </div>
        </div>
