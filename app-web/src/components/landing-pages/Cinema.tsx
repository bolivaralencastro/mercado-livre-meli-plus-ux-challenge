...
const testimonials: Testimonial[] = [
  {
    ...
    text: '"Assinei pelo Disney+ e me surpreendi com o frete grátis. Vale muito a pena!"',
  ...
  },
  {
    ...
    text: '"A economia com os streamings paga a assinatura. Recomendo demais!"',
  ...
  },
  {
    ...
    initials: "AP",
    role: "Cliente Meli+",
    text: '"Melhor combo de entretenimento. Tenho tudo que gosto em um só lugar."',
...
const faqItems: FaqItem[] = [
  {
    question: "Quais streamings estão inclusos?",
    answer: "No plano Mega, você tem Disney+, Deezer Premium (12 meses), e descontos exclusivos em Max, Paramount+ e outros.",
  },
  {
    question: "Como ativo meu Disney+?",
    answer: "Após assinar o Meli+, basta vincular sua conta do Mercado Livre no site ou app do Disney+ para começar a assistir.",
  },
  {
    question: "O Deezer é realmente grátis?",
    answer: "Sim! Assinantes Meli+ têm 12 meses de Deezer Premium totalmente grátis para ouvir música sem anúncios.",
  },
  {
    ...
    <div className={styles.container}>
      ...
      <section className="py-16 text-center relative overflow-visible bg-white">
        <div className="max-w-[1200px] mx-auto px-5 relative">
          <RevealOnScroll>
            <h2 className="text-4xl font-semibold text-gray-900 mb-3">O melhor do entretenimento</h2>
            <p className="text-gray-600 mb-12">Filmes, séries e música sem limites</p>
          </RevealOnScroll>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <BenefitCard
              icon={PlayCircle}
              title="Disney+ e Star+ Incluídos"
              description="Séries, filmes e originais Disney, Pixar, Marvel, Star Wars e National Geographic."
              delay={0.1}
            />
            <BenefitCard
              icon={Music}
              title="Deezer Premium"
              description="Música sem anúncios, modo offline e podcasts exclusivos. 12 meses grátis."
              delay={0.2}
            />
            <BenefitCard
              icon={Tag}
              title="Descontos Exclusivos"
              description="30% OFF em Max, Paramount+ e outros serviços de streaming."
              delay={0.1}
            />
          </div>
        </div>
